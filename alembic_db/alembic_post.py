...
from aot.config import ALEMBIC_UPGRADE_POST
...
def upgrade_revision(error, revision):
    ...
    #     pass  # Code goes here
        ...
        try:
            ...
            command = f'/bin/bash {INSTALL_DIRECTORY}/aot/scripts/upgrade_commands.sh setup-virtualenv-full'
        ...
        from aot.databases.models import DeviceMeasurements
        from aot.databases.models import Input
        from aot.databases.models import Math
        from aot.databases.models import Output
        from aot.databases.models import OutputChannel
        from aot.databases.models import PID
        from aot.databases.models import Trigger
        ...
        from aot.databases.models import DeviceMeasurements
        from aot.databases.models import LCD
        from aot.databases.models import Output
        ...
        from aot.databases.models import ConditionalConditions
        from aot.databases.models import Input
        from aot.inputs.python_code import execute_at_creation
        from aot.utils.conditional import save_conditional_code
