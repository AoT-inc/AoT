...
### Database
- **Database Restructuring**: Deprecated `AoT_dev/databases` and consolidated into `AoT_dev/aot/databases`.
- **Trigger Map**: Fixed `Trigger: Sequence` maps not obeying global coordinate defaults.
