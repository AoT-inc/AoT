...
AoT는 온실·축사·노지를 모니터링하고 제어하는 오픈소스 소프트웨어입니다. 모든 장치·센서·구조물이 지도 위 실제 위치를 갖는 **GIS 디지털 트윈**과, 그 지도를 읽고 진단하며 사용자 승인을 받아 조작하는 **MCP(Model Context Protocol) 기반 AI**를 중심으로 만들어졌습니다.
