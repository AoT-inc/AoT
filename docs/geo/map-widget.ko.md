...
- 장치 이름과 On/Off 토글(**편집 권한**이 있는 사용자에게만 표시)
- 현재 작업 시간 / 마지막 작업 시간
- **시작/종료 시각 설정** 버튼(on/off 장치) — 아래 [예약 켜기](#scheduled-on) 참고
- 노트 작성
...
| 축소 시 라벨 숨기기 | 16 | 이 확대 수준보다 축소하면 시설·출력·입력·함수 라벨과 값 키를 숨깁니다. 사이트·구역 라벨은 위치를 가늠할 수 있도록 항상 표시됩니다. **0으로 두면 숨기지 않습니다.** |
