...
FUNCTION_INFORMATION = {
    ...
    'function_name': lazy_gettext('Sum (Past, Single)'),
    'measurements_dict': measurements_dict,
    'enable_channel_unit_select': True,

    'message': lazy_gettext('This function retrieves past measurements (within Max Age) of the selected measurement, sums them, and stores the result with the selected measurement and unit.'),
