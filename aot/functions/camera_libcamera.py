...
FUNCTION_INFORMATION = {
    ...
    'message': lazy_gettext('Note: This function is currently experimental and should be used at your own risk until this notice is removed. '
               'Captures images and video from the camera using libcamera-still and libcamera-vid. '
               'This function must be enabled to take still images, capture time-lapses, and use the Camera Widget.'),
