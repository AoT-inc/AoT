...
FUNCTION_INFORMATION = {
    ...
    'function_name': lazy_gettext('Bang-Bang Hysteretic (On/Off) (Raise/Lower/Both)'),
    'function_name_short': 'Bang-Bang (On/Off, Raise/Lower/Both)',

    'message': lazy_gettext('A simple Bang-Bang control method that uses a single input value to control one or two outputs. '
               'Select the input, configure the Raise and/or Lower outputs, then enter the **Setpoint and Hysteresis (operating range) and choose the Direction. '
               ...
               '    •\tBoth: adjusts Raise and Lower to keep the input at the setpoint.'),
