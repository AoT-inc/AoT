...
FUNCTION_INFORMATION = {
    ...
    'function_name': lazy_gettext('Difference'),
    'measurements_dict': measurements_dict,
    'enable_channel_unit_select': True,

    'message': lazy_gettext('This function retrieves two measurements, calculates their difference, and stores the result with the selected measurement and unit.'),
