...
FUNCTION_INFORMATION = {
    ...
    'function_name': lazy_gettext('Bang-Bang Hysteretic (On/Off) (Raise/Lower)'),
    'function_name_short': 'Bang-Bang (On/Off, Raise/Lower)',

    'message': lazy_gettext('A simple Bang-Bang control method that uses a single input value to control one output. '
               'Select the input, enter the **output, Setpoint, and Hysteresis**, then choose the Direction. '
