...
FUNCTION_INFORMATION = {
    ...
    'function_name': lazy_gettext('Vapor Pressure Deficit (AVPD)'),
    'measurements_dict': measurements_dict,

    'message': lazy_gettext('This function calculates the Vapor Pressure Deficit (AVPD) using leaf temperature and humidity.'),
