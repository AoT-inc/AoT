...
FUNCTION_INFORMATION = {
    ...
    'function_name': lazy_gettext('Average (Last, Multiple)'),
    'measurements_dict': measurements_dict,
    'enable_channel_unit_select': True,

    'message': lazy_gettext('This function retrieves the last measurement of each selected measurement, averages them, and stores the result with the selected measurement and unit.'),
