...
FUNCTION_INFORMATION = {
    ...
    'function_name': lazy_gettext('Statistics (Last, Multiple)'),
    'measurements_dict': measurements_dict,
    'enable_channel_unit_select': True,

    'message': lazy_gettext('This function retrieves multiple measurements, calculates statistics, and stores the results with the selected unit.'),
