...
WATCH_AREAS = [
    ...
    (
        ...
        (
            ...
            "aot/aot_flask/routes_geo_commissioning.py",
            "aot/aot_flask/routes_geo_plot.py",
            "aot/aot_flask/routes_geo_journal.py",
            "aot/aot_flask/routes_geo_device_split.py",
            "aot/aot_flask/routes_geo_layer.py",
            "aot/aot_flask/routes_geo_shape.py",
            "aot/aot_flask/routes_geo_summary.py",
            "aot/aot_flask/routes_geo_schedule.py",
            "aot/aot_flask/routes_geo_device.py",
            "aot/aot_flask/routes_geo_map.py",
            "aot/aot_flask/routes_geo_facility.py",
