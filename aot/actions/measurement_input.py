# coding=utf-8
#
# measurement_input.py
# 함수에서 사용할 Input 측정값을 등록하는 액션.
...
ACTION_INFORMATION = {
    ...
    'message': lazy_gettext(
        'Register an Input measurement to include in the AoT Average function. '
...
class ActionModule(AbstractFunctionAction):
    """Measurement input slot for AoT_AVG_MULTI function.

    This action stores a measurement selection; it has no execution logic.
