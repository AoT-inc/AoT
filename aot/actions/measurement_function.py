...
# 함수에서 사용할 Function 측정값을 등록하는 액션.
...
ACTION_INFORMATION = {
    'name_unique': 'measurement_function',
    'name': '{}: {}'.format(lazy_gettext('Measurement'), lazy_gettext('Function')),
    'library': None,
    'manufacturer': 'AoT',
    'application': ['functions'],

    'message': lazy_gettext(
        'Register a Function measurement to include in the AoT Average function. '
        'Select computed output values from other functions. '
    ...
    'custom_options': [
        {
            ...
            'name': '{}: {}'.format(lazy_gettext('Measurement'), lazy_gettext('Function')),
            'phrase': lazy_gettext('Function computed measurement to include in the average calculation')
        },
        {
            'id': 'max_measure_age',
            'type': 'integer',
...
class ActionModule(AbstractFunctionAction):
    """Function measurement input slot for AoT_AVG_MULTI function.

    This action stores a Function measurement selection; it has no execution logic.
