...
CHANNELS = {
    0: {'name': '일반지도 (Base)', 'options': {'type': 'base', 'url_template': 'http://map{s}.daumcdn.net/map_2d/2103cov/L{z}/{y}/{x}.png'}},
    1: {'name': '스카이뷰 (Satellite)', 'options': {'type': 'base', 'url_template': 'http://map{s}.daumcdn.net/map_skyview/L{z}/{y}/{x}.jpg'}},
    2: {'name': '하이브리드 (Hybrid)', 'options': {'type': 'overlay', 'url_template': 'http://map{s}.daumcdn.net/map_hybrid/L{z}/{y}/{x}.png'}}
}
...
INPUT_INFORMATION = {
    ...
    'default_url': 'http://map1.daumcdn.net/map_2d/2103cov/L{z}/{y}/{x}.png',
    'layer_type': 'xyz',
    'params': {
        'minZoom': 1,
