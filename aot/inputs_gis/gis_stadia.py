...
INPUT_INFORMATION = {
    ...
    'message': lg('고품질 디자인을 강조하는 Stadia Maps의 지도 서버입니다. Alidade Smooth, Dark, OSMBright 등 눈이 편안한 색감과 고품질 폰트가 적용된 깔끔한 레이아웃을 제공하여 전문가용 대시보드 제작에 유리합니다.'),
    'country': ['GL'],
...
class InputModule(AbstractGisInput):
    """
    Stadia Maps GIS Input (Includes Stamen Design styles).
    """
