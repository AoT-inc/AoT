...
INPUT_INFORMATION = {
    ...
    'message': lg('세계 토양 정보 서비스(ISRIC)에서 제공하는 글로벌 토양 특성 지도입니다. 지질학적 분석을 위한 토양 성분(점토, 모래 등), pH 수치, 탄소 함유량 등 전 세계의 지하 자원 및 환경 정보를 레이어 형태로 시각화해 줍니다.'),
    'country': ['GL'],
...
class InputModule(AbstractGisInput):
    """
    ISRIC SoilGrids WMS.
    Refactored to use channel_selector for static config compatibility.
    """
