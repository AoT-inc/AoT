...
INPUT_INFORMATION = {
    ...
    'message': lg('OpenStreetMap 데이터를 활용하여 특정 목적에 맞춘 독창적인 테마 지도를 제공합니다. 자전거 도로(Cycle), 대중교통(Transport), 밤 지도, 거친 풍경 등 시각적으로 강렬한 고유 스타일을 경험할 수 있습니다.'),
    'country': ['GL'],
...
class InputModule(AbstractGisInput):
    """
    Thunderforest GIS Input (Outdoors & Activities).
    """
