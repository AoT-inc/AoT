...
INPUT_INFORMATION = {
    ...
    'message': lg('마이크로소프트의 글로벌 지도 서비스입니다. 고해상도 항공 사진(Aerial)과 이름이 포함된 항공 사진(Hybrid)을 제공하며, MS만의 깨끗하고 정밀한 도로 지도를 활용할 수 있는 장점이 있습니다.'),
    'country': ['GL'],
...
class InputModule(AbstractGisInput):
    """
    Bing Maps GIS Input (Virtual Earth).
    Uses QuadKey {q} placeholder which is handled by AoTMapLoader extension.
    """
