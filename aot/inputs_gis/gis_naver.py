...
CHANNELS = {
    0: {'name': lg('Basic'), 'options': {'type': 'base', 'url_template': 'https://map.pstatic.net/nrb/styles/basic/{z}/{x}/{y}.png'}},
    1: {'name': lg('Satellite'), 'options': {'type': 'base', 'url_template': 'https://map.pstatic.net/nrb/styles/satellite/{z}/{x}/{y}.png'}},
