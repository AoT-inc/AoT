...
WIDGET_INFORMATION = {
    ...
    'widget_dashboard_body': """{{_('Activated')}}: <span class="aot-w-body" id="status_activated-{{each_widget.unique_id}}"></span><br>{{_('Always')}}: <span class="aot-w-body" id="status_always-{{each_widget.unique_id}}"></span>""",
