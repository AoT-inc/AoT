...
WIDGET_INFORMATION = {
    ...
    'widget_name': lazy_gettext('Gauge (Angular) [Highcharts]'),
    'widget_library': 'Highcharts',
    'no_class': True,

    'message': lazy_gettext('Displays an angular gauge. Be sure to set the Maximum option to the last Stop High value for the gauge to display properly.'),

    'dependencies_module': [
        ('bash-commands',
        [
            '/opt/AoT/aot/aot_flask/static/js/vendor/user_js/highstock-9.1.2.js',
            '/opt/AoT/aot/aot_flask/static/js/vendor/user_js/highcharts-more-9.1.2.js'
        ],
        [
            ...
            'cp -rf Highcharts-Stock-9.1.2/code/highstock.js /opt/AoT/aot/aot_flask/static/js/vendor/user_js/highstock-9.1.2.js',
            'cp -rf Highcharts-Stock-9.1.2/code/highstock.js.map /opt/AoT/aot/aot_flask/static/js/vendor/user_js/highstock-9.1.2.js.map',
            'cp -rf Highcharts-Stock-9.1.2/code/highcharts-more.js /opt/AoT/aot/aot_flask/static/js/vendor/user_js/highcharts-more-9.1.2.js',
            'cp -rf Highcharts-Stock-9.1.2/code/highcharts-more.js.map /opt/AoT/aot/aot_flask/static/js/vendor/user_js/highcharts-more-9.1.2.js.map',
            'rm -rf Highcharts-Stock-9.1.2.zip',
