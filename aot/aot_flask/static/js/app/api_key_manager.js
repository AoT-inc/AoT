...
(function($) {
    ...
    function showSelectionMenu($input, $btn, matches) {
        ...
        const $menu = $('<div class="api-key-selection-menu list-group" style="position:absolute; z-index:var(--aot-z-dropdown); width: 250px; box-shadow: 0 4px 8px rgba(0,0,0,0.2); border: 1px solid #ccc; max-height: 300px; overflow-y: auto; background: white;"></div>');
