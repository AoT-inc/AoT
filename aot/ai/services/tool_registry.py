    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "heading": {"type": "string", "description": "Short title. MUST carry the subject's name AS THE USER SAYS IT — search weighs the heading 3x, so a heading with only a scientific or English name cannot be found later."},
